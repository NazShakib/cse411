package com.company.fontawesomepropoc;
...
public class FontawesomepropocTestContainer extends TestContainer {

    public FontawesomepropocTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/fontawesomepropoc/app.properties",
    ...
    public static class Common extends FontawesomepropocTestContainer {

        public static final FontawesomepropocTestContainer.Common INSTANCE = new FontawesomepropocTestContainer.Common();
