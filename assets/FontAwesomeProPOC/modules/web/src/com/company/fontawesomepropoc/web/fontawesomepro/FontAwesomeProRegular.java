...
public enum FontAwesomeProRegular implements FontIcon {
    ADDRESS_BOOK(0xf2b9),
    ADDRESS_CARD(0xf2bb),
    ADJUST(0xf042),
    ALARM_CLOCK(0xf34e),
    ...
    public static final String FONT_FAMILY = "far";
    private int codepoint;

    FontAwesomeProRegular(int codepoint) {
    ...
    public String getMIMEType() {
        throw new UnsupportedOperationException(FontAwesomeProRegular.class.getSimpleName()
                + " should not be used where a MIME type is needed.");
    }

    public static FontAwesomeProRegular fromCodepoint(final int codepoint) {
        for (FontAwesomeProRegular f : values()) {
            if (f.getCodepoint() == codepoint) {
                return f;
            }
        }
        throw new IllegalArgumentException("Codepoint " + codepoint + " not found in FontAwesomeProRegular");
    }
}