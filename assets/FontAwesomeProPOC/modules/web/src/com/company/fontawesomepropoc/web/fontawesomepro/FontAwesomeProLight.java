...
public enum FontAwesomeProLight implements FontIcon {
    ADDRESS_BOOK(0xf2b9),
    ADDRESS_CARD(0xf2bb),
    ADJUST(0xf042),
    ALARM_CLOCK(0xf34e),
    ...
    public static final String FONT_FAMILY = "fal";
    private int codepoint;

    FontAwesomeProLight(int codepoint) {
    ...
    public String getMIMEType() {
        throw new UnsupportedOperationException(FontAwesomeProLight.class.getSimpleName()
                + " should not be used where a MIME type is needed.");
    }

    public static FontAwesomeProLight fromCodepoint(final int codepoint) {
        for (FontAwesomeProLight f : values()) {
            if (f.getCodepoint() == codepoint) {
                return f;
            }
        }
        throw new IllegalArgumentException("Codepoint " + codepoint + " not found in FontAwesomeProLight");
    }
}