...
<!-- 	            	<div class="media">
	            		...
	            		<div class="media-body">
	            			<h4 class="media-heading"><a href=""><?php echo $cart['pname']; ?></a></h4>
	            			<div class="cart-price">
                              <span> <?php echo $cart['amount']; ?> x</span>
                              <span> <?php  echo $cart['price']; ?></span>
                            </div>
                            <h5><strong>$ <?php echo $subTotal = $cart['amount']* $cart['price']; ?></strong></h5>
	            		</div>
...
<!--                         <span>Total</span>
	          ...
	          <li class="dropdown search dropdown-slide">
	            ...
	            <ul class="dropdown-menu search-dropdown">
	              <li><form action="search.php"><input type="search" name="q" class="form-control" placeholder="Search..."></form></li>
	            </ul>
	          </li><!-- / Search -->
	          <?php 
